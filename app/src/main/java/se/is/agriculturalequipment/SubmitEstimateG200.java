...
//            repairSwitchOnOff = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getTextArray = getIntent().getStringArrayExtra("arrListName");
        ArrayList<String> strListName = (ArrayList<String>) getIntent().getExtras().getSerializable("arrListName");

        Integer element = strListName.size();
        Toast.makeText(this, "Size of element : " +  element + ": Values is : " + strListName, Toast.LENGTH_LONG).show();
